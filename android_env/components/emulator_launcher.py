...
class EmulatorLauncher():
  ...
  def launch(self) -> None:
    ...
    try:
      self._emulator = popen_spawn.PopenSpawn(cmd=command, logfile=self._emulator_output, env=env_vars)
      ...
      # logging.info(f'Emulator log matched: {self._emulator.after} /{self._emulator.before} ')
